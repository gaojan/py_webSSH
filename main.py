...
from app.ssh import handler
from tornado.options import options
from app.base.handler import NotFoundHandler

from app.router import make_urls
from app.application import (get_app_settings,  get_host_keys_settings, get_policy_setting,
...
def make_handlers(loop, options):
    ...
    handlers = make_urls(loop, policy, host_keys_settings)
